...
<body>
    ...
    <!--!!!!!!!! Size modufication later-->
      ...
      <div class="centering flex-1 pl-16">
        <main id="pader">
          <div
            class="flexer min-h-[300px] flex justify-between rounded-[60px] absolute overflow-hidden bg-white z-2"
          >
            <div
              class="signin py-[5%] flex flex-col justify-evenly items-center"
            >
              <h1 class="font-bold text-[20px] pb-7 text-black">SIGN IN</h1>
              ...
              <p class="marger m-10 font-medium text-black">
              ...
              <form class="h-fit flex flex-col justify-center" id="loginForm" action="includes/login.inc.php" method="POST">
                <input
                  ...
                  id="loginusername" name="username"                  placeholder="User Name"
                  class="border-b-2 w-[100%] outline-none text-black"
                  required
                />
                <span id="text"></span>
                ...
                <input
                  ...
                  class="border-b-2 text-black mt-8 w-[100%] outline-none"
                  required
                />
            ...
            <div
              id="loger"
              class="loger absolute py-36 h-[460px] w-[70%] flex justify-evenly bg-sky-500"
            >
              <div
                id="cont"
                class="cont absolute flex flex-col justify-evenly items-center"
              >
                <h1 class="font-bold mb-5 text-[25px] text-black">
                  welcome, friend !
                </h1>
                <p
                  class="messageanas text-white mb-5 font-bold text-center text-[15px] w-fit"
                >
                ...
                <a
                  id="registerButton"
                  href="#"
                  class="font-bold bg-sky-600 border-[2px] border-white px-28 py-3 rounded-[30px]"
                  >Sign Up</a
                >
                <a
                  id="resetButton"
                  href="#"
                  class="font-bold m-2 text-black underline border-white rounded-[30px]"
                  >Reset Password</a
                >
              </div>
            </div>
            <div
              class="signin1 py-[5%] flex flex-col justify-evenly items-center"
            >
              <h1
                class="font-bold text-center text-black w-[100%] text-[30px] pb-7"
              >
                CREATE ACCOUNT
              </h1>
              <div class="icons flex w-[60%] justify-evenly">
              ...
              <form
                class="h-fit flex flex-col justify-center"
                id="registrationForm"
                method="POST"
              >
                <input
                  ...
                  class="border-b-2 text-black mt-8 w-full outline-none"
                  required
                />
                ...
                <input
                  ...
                  placeholder="Email"
                  oninput="validation()"
                  class="border-b-2 text-black mt-3 w-full outline-none"
                  required
                />
                <span id="text1"></span>
                ...
                <input
                  ...
                  type="submit"
                  value="Sign-Up"
                  class="font-bold cursor-pointer text-white my-5 mx-auto bg-purple-300 px-16 py-3 rounded-[30px]"
                />
              </form>
